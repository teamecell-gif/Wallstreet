          ...
          <div className="md:col-span-4 flex flex-col gap-6 items-center md:items-center">
            <div className="flex flex-col gap-6 items-center md:items-start">
              ...
              <div className="flex flex-col gap-6">
                <div>
                  <p className="text-white/80 font-bold text-xs mb-2 uppercase tracking-widest">For Event Queries:</p>
                  <a className="text-white/60 hover:text-primary transition-colors text-base break-all" href="mailto:contact@wallstreetcompetition.org">contact@wallstreetcompetition.org</a>
                </div>
                <div>
                  <p className="text-white/80 font-bold text-xs mb-2 uppercase tracking-widest">For Sponsorships:</p>
                  <a className="text-white/60 hover:text-primary transition-colors text-base break-all" href="mailto:partners@wallstreetcompetition.org">partners@wallstreetcompetition.org</a>
                </div>
              </div>
            </div>
          </div>
          <div className="md:col-span-4 flex flex-col gap-6 items-center md:items-end">
            <div className="flex flex-col gap-6 items-center md:items-start">
              ...
              <div className="flex items-center gap-5">
                <a aria-label="Instagram" className="text-primary hover:scale-125 transition-all p-2 rounded-lg bg-primary/5 hover:bg-primary/10" href="#">
                ...
                <a aria-label="LinkedIn" className="text-primary hover:scale-125 transition-all p-2 rounded-lg bg-primary/5 hover:bg-primary/10" href="#">
                ...
                <a aria-label="YouTube" className="text-primary hover:scale-125 transition-all p-2 rounded-lg bg-primary/5 hover:bg-primary/10" href="#">
                ...
                <a aria-label="X / Twitter" className="text-primary hover:scale-125 transition-all p-2 rounded-lg bg-primary/5 hover:bg-primary/10" href="#">
