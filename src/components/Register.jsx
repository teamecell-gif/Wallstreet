  ...
  return (
    <section className="py-24 bg-surface-dark/20 relative overflow-hidden" id="register">
      ...
      <div className="max-w-[800px] mx-auto px-4 relative z-10">
        <div className="bg-surface-dark border border-border-dark rounded-2xl p-8 md:p-12 shadow-2xl">
          <div className="flex flex-col gap-8">
            ...
            <form className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="md:col-span-2 pt-4">
                <button className="w-full h-14 bg-primary text-background-dark font-black text-lg rounded-lg hover:bg-primary/90 transition-all glow-orange" type="submit">
                  Submit Registration
                </button>
              </div>
            </form>
